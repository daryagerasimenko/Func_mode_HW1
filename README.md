...
4. Далее по формуле из работы "The pragmatics of expressive content: Evidence from large corpora" были вычислены значения log-odds, которые на получившихся графиках отложены на оси y. На оси x — значения от -1 до 1, где -1 — соответствует негативной тональности текста, 0,5 — нейтральной, 1 — положительной. 
